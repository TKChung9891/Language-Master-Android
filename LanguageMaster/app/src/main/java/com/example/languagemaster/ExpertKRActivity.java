...
public class ExpertKRActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expertkr);
        /// Nav Drawer
        ...
        // Create new instance of TTS with Language set to Korean
        ...
        toggleBtnSpeak.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) // If button is ON, get permission from user to record audio with the mic
                {
                    ...
                    ActivityCompat.requestPermissions(ExpertKRActivity.this,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                ...
                {
                    Toast.makeText(ExpertKRActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
