...
public class BeginnerKRActivity extends AppCompatActivity
    ...
    private EditText inputText, txtListen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginnerkr);
        /// Nav Drawer
        ...
        //Set onclickListener for Translate Button
        btnTranslate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                translate.execute(inputText.getText().toString(),"en","ko");
            }
        });
        ...
        intentRecognizer.putExtra(RecognizerIntent.EXTRA_LANGUAGE, "ko-KR");
        intentRecognizer.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, "ko-KR");
        ...
        toggleBtnSpeak.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) // If button is ON, get permission from user to record audio with the mic
                {
                    ...
                    ActivityCompat.requestPermissions(BeginnerKRActivity.this,
...
//                finish();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                ...
                {
                    Toast.makeText(BeginnerKRActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    public void onResults(Bundle results) {
        ...
        String msgToast;
        if (bestResult.equals(txtListen.getText().toString())) {msgToast = "Correct! Congrats!!";}
        else {msgToast="Oops...Try Again!";}
        Toast.makeText(BeginnerKRActivity.this, msgToast, Toast.LENGTH_LONG).show();
    }
