...
public class BeginnerJPActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginnerjp);
        /// Nav Drawer
        ...
        btnTranslate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                translate.execute(inputText.getText().toString(),"en","ja");
            }
        });
        ...
        toggleBtnSpeak.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) // If button is ON, get permission from user to record audio with the mic
                {
                    ...
                    ActivityCompat.requestPermissions(BeginnerJPActivity.this,
...
//                finish();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        switch (requestCode) {
            case REQUEST_RECORD_PERMISSION:
                ...
                {
                    Toast.makeText(BeginnerJPActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    public void onResults(Bundle results) {
        ...
        Toast.makeText(BeginnerJPActivity.this, msgToast, Toast.LENGTH_LONG).show();
    }
